    ...
    return (
        <div>
            <footer className='fixed-bottom bg-green d-flex shadow border-top text-white rounded-top justify-content-between px-5' style={{ height: "75px" }}>
                ...
                <a className='btn btn-green border my-auto d-flex'><FaEnvelope className='me-2 my-auto' />admin@eng.jfn.ac.lk</a>
                <a className='btn btn-green border my-auto d-flex'><GiRotaryPhone className='me-2 my-auto' />+94-021-2062161</a>
                <a className='btn btn-green border my-auto d-flex'><FaFacebook className='me-2 my-auto' />FOE | UOJ</a>
            </footer>
        </div>
    )
}
